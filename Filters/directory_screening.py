...
for i, file in enumerate(all_files):
    ...
    filterer = FileFilter()
    filterer.assess_file(filepath=file, cnn_model=cnn_model, assess_euler=False, savedir="/home/mltest1/tmp/pycharm_project_883/Data/Classification_Performance_Images/Filtered_All_NewModel/Filtered")
