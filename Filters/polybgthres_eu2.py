# Finds and processes ibws in eu_test
...
sav_loc = r'thres_img/eu_tests/res3/' + file_name.replace('.ibw', '')
...
if opt_thres != 0:
    ...
    plt.imsave(sav_loc + '_THRES.png', norm_data_Trace_Array > opt_thres, cmap='gray')# The image is flipped vertically
else:
    plt.savefig(sav_loc + '.png')
...
M_best = models[1] # Only tries N=2 rn

x = np.linspace(0, 0.2, 1000) # range is fudged, return to 0 to 1
